...
import { FaCalendarAlt, FaStopwatch, FaLink, FaUndo, FaBrain, FaCode, FaServer, FaArrowRight, FaCubes, FaTimes, FaUsers, FaCogs, FaRobot, FaFilm } from 'react-icons/fa';
                         ...
                         <div className="flex-grow grid grid-cols-2 gap-8 items-center">
                            <div className="text-center p-6 border-r-2 border-gray-200">
                                ...
                                <div className="space-y-4">
                                    <div className="relative inline-block m-2 animate-pop-in"><FaCubes className="text-6xl text-secondary"/><FaTimes className="absolute -top-2 -right-2 text-4xl text-red-500 animate-stamp" style={{animationDelay: '0.5s'}}/></div>
                                    <div className="relative inline-block m-2 animate-pop-in" style={{animationDelay: '0.2s'}}><FaServer className="text-6xl text-secondary"/><FaTimes className="absolute -top-2 -right-2 text-4xl text-red-500 animate-stamp" style={{animationDelay: '0.7s'}}/></div>
                                    <div className="relative inline-block m-2 animate-pop-in" style={{animationDelay: '0.4s'}}><FaUsers className="text-6xl text-secondary"/><FaTimes className="absolute -top-2 -right-2 text-4xl text-red-500 animate-stamp" style={{animationDelay: '0.9s'}}/></div>
                                </div>
                            </div>
                            <div className="p-6">
