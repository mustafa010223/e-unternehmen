...
import {
  ...
  FaHandPaper, FaRobot, FaBook, FaCubes
} from 'react-icons/fa';
...
const iconProps = { className: "inline-block mr-4 text-2xl text-secondary" };
const toolIconProps = { className: "inline-block mx-auto text-4xl text-secondary" };
...
export const SLIDE_DATA: SlideData[] = [
  ...
  },
  {
    ...
    twoColumn: {
      ...
      right: { title: 'Sürekli Dağıtım (Continuous Deployment)', content: 'Build (auto) → Test (auto) → Deploy to Stage (auto) → Deploy to Production (AUTO)', icon: <FaRobot className="text-5xl text-primary" /> },
    },
  },
  {
    id: 18,
